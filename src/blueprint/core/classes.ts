...
export function alignmentClass(alignment: Alignment | undefined | null) {
  switch (alignment) {
    case Alignment.LEFT:
      return ALIGN_LEFT;
...
export function elevationClass(elevation: Elevation | undefined | null): string | undefined;
export function elevationClass(elevation: Elevation | undefined | null) {
...
export function iconClass(iconName: string | undefined | null) {
  if (iconName == null) {
    return undefined;
  }
...
export function intentClass(intent: typeof Intent.NONE | undefined | null): undefined;
export function intentClass(intent: Intent | undefined | null): Intent | undefined;
export function intentClass(intent: Intent | undefined | null) {
...
export function positionClass(position: Position | undefined | null): string | undefined;
export function positionClass(position: Position | undefined | null) {
